      ...
      {dpsScore && (
        <div className="max-w-md mx-auto">
          <div className={`
            ...
            ${dpsTier === 'Viral Potential' || dpsTier === 'Excellent - Top 10%' ? 'bg-green-500/10 border-green-500/30' :
              dpsTier === 'Good - Top 25%' ? 'bg-blue-500/10 border-blue-500/30' :
          ...
          `}>
            ...
            <p className="text-2xl font-bold text-white">
              ...
              <span className={`ml-2 text-sm capitalize ${
                dpsTier === 'Viral Potential' || dpsTier === 'Excellent - Top 10%' ? 'text-green-400' :
                dpsTier === 'Good - Top 25%' ? 'text-blue-400' : 'text-yellow-400'
              }`}>
                ({dpsTier})
              </span>
            </p>
