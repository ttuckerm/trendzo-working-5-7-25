...
export function DPSPredictionStep({ data, createData, planData, researchData, onUpdate, onNext, onBack }: StepProps) {
  ...
  const tierColors: Record<string, string> = {
    'Needs Work': 'from-red-500 to-red-600',
    'Average': 'from-yellow-500 to-orange-500',
    'Good - Top 25%': 'from-green-500 to-emerald-500',
    'Excellent - Top 10%': 'from-blue-500 to-purple-500',
    'Viral Potential': 'from-purple-500 to-pink-500',
  };
