...
export interface DPSPredictionResponse {
  ...
  predicted_tier_7d: 'Viral Potential' | 'Excellent - Top 10%' | 'Good - Top 25%' | 'Average' | 'Needs Work' | 'unknown';
  confidence: number;
  success: boolean;
...
// REMOVED: calculateDPSFromMetrics — DPS computation is now centralized in
// src/lib/training/dps-v2.ts. Use computeDpsV2FromRows() for all DPS scoring.
