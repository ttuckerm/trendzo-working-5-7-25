/**
 * Rubric Engine - Pack 1, Pack 2, Pack 3 (Viral Mechanics), & Pack V (Visual)
 *
 * Pack 1: Unified Grading Rubric (requires transcript)
 * Pack 2: Editing Coach (requires Pack 1)
 * Pack 3: Viral Mechanics (rule-based, synthesizes all signals)
...
// ============================================================================
// Pack 3: Viral Mechanics (rule-based)
// ============================================================================
...
export { VIRAL_MECHANICS } from './viral-mechanics-types';

export type { ViralMechanicsExecutionResult } from './viral-mechanics-runner';
