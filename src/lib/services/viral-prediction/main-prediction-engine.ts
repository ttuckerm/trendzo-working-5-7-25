...
import { DynamicPercentileSystem } from './dynamic-percentile-system';
...
export class MainPredictionEngine {
  private supabase;
  private dps: DynamicPercentileSystem;
  ...
  constructor() {
    ...
    this.dps = new DynamicPercentileSystem();
  ...
  async analyzeTrendingContent(): Promise<void> {
    ...
    // Update cohort medians hourly
    await this.dps.updateCohortMedians();
