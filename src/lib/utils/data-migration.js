...
function getSupabaseAdminClient() {
  ...
  const supabaseServiceKey = getEnvVariable('SUPABASE_SERVICE_KEY');
  
  if (!supabaseUrl || !supabaseServiceKey) {
    throw new Error('Required Supabase configuration missing. Please set NEXT_PUBLIC_SUPABASE_URL and SUPABASE_SERVICE_KEY in your .env.local file.');
  }
