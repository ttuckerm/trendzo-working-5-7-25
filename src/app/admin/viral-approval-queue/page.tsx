...
export default function ViralApprovalQueue() {
    ...
    return (
      <div className="flex items-center justify-center min-h-96">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading viral approval queue...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Viral Approval Queue</h1>
        <p className="text-gray-600">Review AI-detected viral videos for template generation</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="relative">
          ...
          <select
            ...
            className="pl-10 pr-8 py-3 bg-white border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none"
          >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="text-sm text-gray-500">AI Approved</div>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
          <div className="text-2xl font-bold text-purple-600">
            {queueItems.filter(item => item.readyForTemplate).length}
          </div>
          <div className="text-sm text-gray-500">Ready for Templates</div>
        </div>
      </div>
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {item.hashtags.slice(0, 4).map((tag, index) => (
                        <span key={index} className="px-2 py-1 bg-purple-100 rounded text-xs text-purple-700">
                          {tag}
                        </span>
                      ))}
                  ...
                  <div className="flex lg:flex-col gap-3">
                    ...
                    <button
                      ...
                      disabled={item.status !== 'pending'}
                      className="flex items-center gap-2 px-4 py-2 bg-yellow-600 hover:bg-yellow-700 rounded-lg text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                    ...
                    <button
                      ...
                      disabled={item.status !== 'pending'}
                      className="flex items-center gap-2 px-4 py-2 bg-red-600 hover:bg-red-700 rounded-lg text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
      ...
      {filteredItems.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">No videos in queue</h3>
          <p className="text-gray-600">Start a scraping job to populate the approval queue</p>
        </div>
      )}
    </div>
  );
