    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0F0A1E] to-[#1a0f2e]">
      ...
      <div className="flex">
        ...
        <div className="flex-1 p-10 text-white">
          ...
          {currentStep === 1 && (
            <div>
              <h1 className="text-4xl font-bold mb-3">Intake & Freeze</h1>
              <p className="text-gray-300 mb-8 text-lg">Freeze cohort data and establish DPS baseline</p>

              <div className="grid grid-cols-4 gap-6 mb-8">
                <div className="bg-white/10 backdrop-blur-sm border-2 border-cyan-500/40 rounded-xl p-6 text-center">
                  <div className="text-4xl font-bold text-cyan-400">{runData.cohort?.total_videos_scraped || '...'}</div>
