...
export default function DNADetectivePage() {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-lg">
            First per-video predictor providing fast baseline viral predictions
          </p>
        </div>
          ...
          <CardContent>
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">
                DNA_Detective Coming Soon
              </h3>
              <p className="text-gray-400 max-w-md">
                Fast baseline predictor that analyzes video DNA patterns for initial viral scoring.
              </p>
              <div className="mt-6 space-y-2 text-left">
                <p className="text-sm text-gray-500">
                  • ⚡ Fast baseline predictions (&lt;2s per video)
                </p>
                <p className="text-sm text-gray-500">
                  • 🧬 Analyze gene vector patterns for viral markers
                </p>
                <p className="text-sm text-gray-500">
                  • 📈 Generate confidence scores (0-100%)
                </p>
                <p className="text-sm text-gray-500">
                  • 🎯 First-pass filtering before advanced predictors
                </p>
              </div>
            </div>
          </CardContent>
