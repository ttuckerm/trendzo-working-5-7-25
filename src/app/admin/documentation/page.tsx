...
function ResourceCard({ 
  ...
  const handleClick = (e: React.MouseEvent) => {
    e.preventDefault();
    console.log('[Admin Documentation] Direct navigation to:', href);
...
export default function AdminDocumentationPage() {
  ...
  const navigateTo = (path: string) => (e: React.MouseEvent) => {
    e.preventDefault();
    console.log('[Admin Documentation] Direct navigation to:', path);
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-sm text-gray-500 mb-4">Super Admin Documentation Center</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        <ResourceCard
          ...
          href="/admin/documentation/ComponentOptimizationGuide"
        ...
        <ResourceCard
          ...
          href="/admin/documentation/UXUIStyleGuide"
        ...
        <ResourceCard
          ...
          href="/admin/documentation/PerformanceChecklist"
        ...
        <ResourceCard
          ...
          href="/admin/documentation/optimization-demo"
      ...
      <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
        ...
        <div className="mt-4">
          <a 
            href="/admin/documentation/optimization-demo"
            onClick={navigateTo('/admin/documentation/optimization-demo')}
