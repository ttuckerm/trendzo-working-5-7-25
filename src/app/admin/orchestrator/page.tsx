      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-lg">
            Intelligent service that picks which predictor(s) to run and blends results
          </p>
        </div>
          ...
          <CardContent>
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="text-gray-400 max-w-md">
                Smart coordination layer that decides which predictors to use and combines their outputs.
              </p>
              <div className="mt-6 space-y-2 text-left">
                <p className="text-sm text-gray-500">
                  • 🧠 Intelligent predictor selection based on content type
                </p>
                <p className="text-sm text-gray-500">
                  • ⚖️ Weighted blending of multiple predictor results
                </p>
                <p className="text-sm text-gray-500">
                  • 📊 Performance-based predictor prioritization
                </p>
                <p className="text-sm text-gray-500">
