  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] animate-[fadeSlideUp_0.5s_ease-out_both]">
      <div className="text-center space-y-4">
        ...
        <h2 className="text-xl font-display font-bold text-[#e8e6e3]">Network Intel</h2>
        <p className="text-sm text-[#7a7889] max-w-md font-body">
          Creator network analysis and collaboration opportunities — coming soon.
        </p>
        <span className="inline-block px-3 py-1 text-[10px] font-mono-label uppercase tracking-[0.12em] rounded-full bg-[#f4b942]/10 text-[#f4b942] border border-[#f4b942]/20">
          Coming Soon
        </span>
      </div>
    </div>
