...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const prediction = {
      ...
      tierProbabilities: {
        'Viral Potential': pipelineResult.predicted_tier_7d === 'Viral Potential' ? 0.8 : 0.1,
        'Excellent - Top 10%': pipelineResult.predicted_tier_7d === 'Excellent - Top 10%' ? 0.8 : 0.2,
        'Good - Top 25%': pipelineResult.predicted_tier_7d === 'Good - Top 25%' ? 0.8 : 0.3,
        'Average': pipelineResult.predicted_tier_7d === 'Average' ? 0.8 : 0.3,
        'Needs Work': pipelineResult.predicted_tier_7d === 'Needs Work' ? 0.8 : 0.1,
      },
      predictions: {
