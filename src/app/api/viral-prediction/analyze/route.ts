  ...
  try {
    ...
    const analysis = {
      ...
      dpsAnalysis: {
        ...
        cohortSize: 100,
        relativePerformance: pipelineResult.predicted_tier_7d === 'Viral Potential' || pipelineResult.predicted_tier_7d === 'Excellent - Top 10%'
          ? 'exceptional'
          : pipelineResult.predicted_tier_7d === 'Good - Top 25%' ? 'strong' : 'average',
        velocityIndicators: {
          likesPerHour: 0,
