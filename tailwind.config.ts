    ...
    extend: {
      colors: {
        ...
        glass: {
          ...
          "accent-primary": "var(--glass-accent-primary)",
          "accent-secondary": "var(--glass-accent-secondary)",
          "accent-tertiary": "var(--glass-accent-tertiary)",
      ...
      backgroundImage: {
        ...
        "glass-gradient": "linear-gradient(135deg, rgba(100, 150, 255, 0.03) 0%, transparent 100%)",
      },
      backdropBlur: {
      ...
      boxShadow: {
        ...
        "glass-glow-success": "0 0 60px var(--glass-success-glow)",
        "glass-glow-tertiary": "0 0 40px var(--glass-accent-tertiary-glow)",
      },
      backgroundSize: {
        auto: "auto",
        cover: "cover",
