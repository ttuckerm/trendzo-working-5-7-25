-- =====================================================
-- WORKING VIRAL VIDEO GALLERY POPULATION SCRIPT
-- =====================================================
-- Fixed PostgreSQL syntax - no bare RAISE NOTICE statements
...
-- BUILD PHASE: Insert viral video gallery data
...
-- Insert framework mappings with proper relationships
...
SELECT 
  video_id,
  framework_id,
  LEAST(0.950, effectiveness_score),
  jsonb_build_object(
...
-- DEPLOY PHASE: Final verification
DO $$
DECLARE
