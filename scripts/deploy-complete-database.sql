-- =====================================================
-- COMPLETE DATABASE DEPLOYMENT FOR TRENDZO
-- Deploys schema + populates real data in one script
-- =====================================================
...
-- Viral Video Gallery for Value Template Editor
...
('Creative Showcase', 'visual', 
    ...
    'COOLING', 0.75),
('Trending Audio Hook', 'audio', 
    '{"pattern": "music_sync", "timing": "immediate", "elements": ["popular_sound", "perfect_timing", "visual_match"], "emotional_triggers": ["familiarity", "trend_participation", "entertainment"], "optimal_duration": 25, "hook_timing": 1, "proof_requirements": ["trending_audio", "perfect_sync", "visual_match"]}'::jsonb, 
    'COOLING', 0.68);
...
SELECT 'Complete database deployment successful! 🚀' as status,
